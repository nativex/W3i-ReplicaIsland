...
public class AnimationComponent extends GameComponent {
	...
	public void setJetSprite(
			SpriteComponent sprite) {
		mJetSprite = sprite;
	}

	public void setSparksSprite(
			SpriteComponent sprite) {
	...
	public final void setDamageSwap(
			ChangeComponentsComponent damageSwap) {
		mDamageSwap = damageSwap;
	}

	public void setLandThump(
			Sound land) {
		mLandThump = land;
	}
