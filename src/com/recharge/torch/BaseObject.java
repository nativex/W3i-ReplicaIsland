...
/**
 * The core object from which most other objects are derived. Anything that will be managed by an ObjectManager, and anything that requires an update per frame should be derived from BaseObject.
 * BaseObject also defines the interface for the object-wide system registry.
 */
