...
public class ButtonAnimationComponent extends GameComponent {
	...
	public void update(
		...
		if (mSprite != null) {
			...
			if (parentObject.getCurrentAction() == GameObject.ActionType.HIT_REACT && parentObject.lastReceivedHitType == CollisionParameters.HitType.DEPRESS) {
