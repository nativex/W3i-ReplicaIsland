...
/**
 * A game component that can swap other components in and out of its parent game object. The purpose of the ChangeComponentsComponent is to allow game objects to have different "modes" defined by
 * different combinations of GameComponents. ChangeComponentsComponent manages the switching in and out of those modes by activating and deactivating specific game components.
 */
public class ChangeComponentsComponent extends GameComponent {
	...
	public void addSwapInComponent(
			GameComponent component) {
		mComponentsToInsert.add(component);
	}

	public void addSwapOutComponent(
			GameComponent component) {
		mComponentsToRemove.add(component);
	}

	public void setPingPongBehavior(
			boolean pingPong) {
		mPingPong = pingPong;
	}
	...
	/**
	 * Inserts and removes components added to the swap-in and swap-out list, respectively. Unless mPingPong is set, this may only be called once.
	 * 
	 * @param parent
