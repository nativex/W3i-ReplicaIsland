...
/**
 * A game component implements a single feature of a game object. Components are run once per frame when their parent object is active. Updating a game object is equivalent to updating all of its
 * components. Note that a game object may contain more than one instance of the same type of component.
 */
