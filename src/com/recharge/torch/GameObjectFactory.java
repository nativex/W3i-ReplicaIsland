...
import com.recharge.torch.CollisionParameters.HitType;
import com.recharge.torch.EnemyAnimationComponent.EnemyAnimations;
import com.recharge.torch.GameObject.ActionType;
import com.recharge.torch.GameObject.Team;
import com.recharge.torch.GenericAnimationComponent.Animation;
import com.recharge.torch.activities.AnimationPlayerActivity;
import com.recharge.torch.skins.Skin;
 ...
 * full of large functions that just patch pointers between objects, but in the future those functions should either be a) generated from data at compile time, or b) described by data at runtime.
 */
public class GameObjectFactory extends BaseObject {
	...
	public enum GameObjectType {
		...
		// Collectables
		COIN(1), RUBY(2), DIARY(3),

		// Characters
		WANDA(10), KYLE(11), KYLE_DEAD(12), ANDOU_DEAD(13), KABOCHA(26), ROKUDOU_TERMINAL(27), KABOCHA_TERMINAL(28), EVIL_KABOCHA(29), ROKUDOU(30),

		// AI
		BROBOT(16), SNAILBOMB(17), SHADOWSLIME(18), MUDMAN(19), SKELETON(20), KARAGUIN(21), PINK_NAMAZU(22), TURRET(23), TURRET_LEFT(24), BAT(6), STING(7), ONION(8),

		// Objects
		DOOR_RED(32), DOOR_BLUE(33), DOOR_GREEN(34), BUTTON_RED(35), BUTTON_BLUE(36), BUTTON_GREEN(37), CANNON(38), BROBOT_SPAWNER(39), BROBOT_SPAWNER_LEFT(40), BREAKABLE_BLOCK(41), THE_SOURCE(42), HINT_SIGN(43),

		// Effects
		DUST(48), EXPLOSION_SMALL(49), EXPLOSION_LARGE(50), EXPLOSION_GIANT(51),

		// Special Spawnable
		DOOR_RED_NONBLOCKING(52), DOOR_BLUE_NONBLOCKING(53), DOOR_GREEN_NONBLOCKING(54),

		GHOST_NPC(55),

		CAMERA_BIAS(56),

		FRAMERATE_WATCHER(57), INFINITE_SPAWNER(58), CRUSHER_ANDOU(59),

		// Projectiles
		ENERGY_BALL(68), CANNON_BALL(65), TURRET_BULLET(66), BROBOT_BULLET(67), BREAKABLE_BLOCK_PIECE(68), BREAKABLE_BLOCK_PIECE_SPAWNER(69), WANDA_SHOT(70),

		// Special Objects -- Not spawnable normally
		SMOKE_BIG(-1), SMOKE_SMALL(-1),

		CRUSH_FLASH(-1), FLASH(-1),

		PLAYER_JETS(-1), PLAYER_SPARKS(-1), PLAYER_GLOW(-1), ENEMY_SPARKS(-1), GHOST(-1), SMOKE_POOF(-1), GEM_EFFECT(-1), GEM_EFFECT_SPAWNER(-1),
		...
		public static GameObjectType indexToType(
				int index) {
	...
	public GameObjectFactory() {
		...
		ComponentClass[] componentTypes = { new ComponentClass(AnimationComponent.class, 1), new ComponentClass(AttackAtDistanceComponent.class, 16), new ComponentClass(BackgroundCollisionComponent.class, 192), new ComponentClass(ButtonAnimationComponent.class, 32), new ComponentClass(CameraBiasComponent.class, 8), new ComponentClass(ChangeComponentsComponent.class, 256), new ComponentClass(CrusherAndouComponent.class, 1), new ComponentClass(DoorAnimationComponent.class, 256), // !
				new ComponentClass(DynamicCollisionComponent.class, 256), new ComponentClass(EnemyAnimationComponent.class, 256), new ComponentClass(FadeDrawableComponent.class, 32), new ComponentClass(FixedAnimationComponent.class, 8), new ComponentClass(FrameRateWatcherComponent.class, 1), new ComponentClass(GenericAnimationComponent.class, 32), new ComponentClass(GhostComponent.class, 256), new ComponentClass(GravityComponent.class, 128), new ComponentClass(HitPlayerComponent.class, 256), new ComponentClass(HitReactionComponent.class, 256), new ComponentClass(InventoryComponent.class, 128), new ComponentClass(LauncherComponent.class, 16), new ComponentClass(LaunchProjectileComponent.class, 128), new ComponentClass(LifetimeComponent.class, 384), new ComponentClass(MotionBlurComponent.class, 1), new ComponentClass(MovementComponent.class, 128), new ComponentClass(NPCAnimationComponent.class, 8), new ComponentClass(NPCComponent.class, 8), new ComponentClass(OrbitalMagnetComponent.class, 1), new ComponentClass(PatrolComponent.class, 256), new ComponentClass(PhysicsComponent.class, 8), new ComponentClass(PlayerComponent.class, 1), new ComponentClass(PlaySingleSoundComponent.class, 128), new ComponentClass(PopOutComponent.class, 32), new ComponentClass(RenderComponent.class, 384), new ComponentClass(ScrollerComponent.class, 8), new ComponentClass(SelectDialogComponent.class, 8), new ComponentClass(SimpleCollisionComponent.class, 32), new ComponentClass(SimplePhysicsComponent.class, 256), new ComponentClass(SleeperComponent.class, 32), new ComponentClass(SolidSurfaceComponent.class, 16), new ComponentClass(SpriteComponent.class, 384), new ComponentClass(TheSourceComponent.class, 1),
	...
	protected GameComponentPool getComponentPool(
			Class<?> componentType) {
	...
	protected GameComponent allocateComponent(
			Class<?> componentType) {
	...
	private FixedSizeArray<BaseObject> getStaticData(
			GameObjectType type) {
	...
	public void sanityCheckPools() {
		...
		if (outstandingObjects != 0) {
			DebugLog.d("Sanity Check", "Outstanding game object allocations! (" + outstandingObjects + ")");
			assert false;
		}
		...
		for (int x = 0; x < componentPoolCount; x++) {
			...
			if (outstandingComponents != 0) {
				DebugLog.d("Sanity Check", "Outstanding " + mComponentPools.get(x).objectClass.getSimpleName() + " allocations! (" + outstandingComponents + ")");
				// assert false;
			}
		}
	}
	...
	public GameObject spawnPlayer(
		...
		// Sparks
		{
			...
			if (sparksStaticData == null) {
				...
				sparksAnim.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.spark01), Utils.framesToTime(24, 1)));
				sparksAnim.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.spark02), Utils.framesToTime(24, 1)));
				sparksAnim.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.spark03), Utils.framesToTime(24, 1)));
		...
		// Glow
		{
			...
			DynamicCollisionComponent glowCollision = (DynamicCollisionComponent) allocateComponent(DynamicCollisionComponent.class);
			...
			glowFade.setupFade(1.0f, 0.0f, 0.15f, FadeDrawableComponent.LOOP_TYPE_PING_PONG, FadeDrawableComponent.FADE_EASE, glowDuration - 4.0f); // 4 seconds before the glow ends, start flashing
	...
	private void setupEnemySparks() {
		...
		if (staticData == null) {
			...
			AnimationFrame frame1 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.spark01), Utils.framesToTime(24, 1));
			AnimationFrame frame2 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.spark02), Utils.framesToTime(24, 1));
			AnimationFrame frame3 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.spark03), Utils.framesToTime(24, 1));
	...
	public GameObject spawnEnemyBrobot(
			float positionX,
			float positionY,
		...
		if (staticData == null) {
			...
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_brobot_idle01), Utils.framesToTime(24, 3), basicAttackVolume, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_brobot_idle02), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_brobot_idle03), Utils.framesToTime(24, 3), basicAttackVolume, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_brobot_idle02), Utils.framesToTime(24, 3), basicAttackVolume, basicVulnerabilityVolume));

			idle.setLoop(true);

			SpriteAnimation walk = new SpriteAnimation(EnemyAnimations.MOVE.ordinal(), 3);
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_brobot_walk01), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_brobot_walk02), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_brobot_walk03), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume));
			walk.setLoop(true);
	...
	public GameObject spawnEnemySnailBomb(
			float positionX,
			float positionY,
			boolean flipHorizontal) {
		...
		if (staticData == null) {
			...
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.snailbomb_stand), Utils.framesToTime(24, 3), basicAttackVolume, basicVulnerabilityVolume));

			SpriteAnimation walk = new SpriteAnimation(EnemyAnimations.MOVE.ordinal(), 5);
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.snailbomb_stand), Utils.framesToTime(24, 2), basicAttackVolume, basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.snailbomb_walk01), Utils.framesToTime(24, 2), basicAttackVolume, basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.snailbomb_walk02), Utils.framesToTime(24, 6), basicAttackVolume, basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.snailbomb_walk01), Utils.framesToTime(24, 2), basicAttackVolume, basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.snailbomb_stand), Utils.framesToTime(24, 2), basicAttackVolume, basicVulnerabilityVolume));
			walk.setLoop(true);

			SpriteAnimation attack = new SpriteAnimation(EnemyAnimations.ATTACK.ordinal(), 2);
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.snailbomb_shoot01), Utils.framesToTime(24, 3), basicAttackVolume, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.snailbomb_shoot02), Utils.framesToTime(24, 2), basicAttackVolume, basicVulnerabilityVolume));
		...
		lifetime.setIncrementEventCounter(EventRecorder.COUNTER_SNAIL_BOMBS_DESTROYED);

		LaunchProjectileComponent gun = (LaunchProjectileComponent) allocateComponent(LaunchProjectileComponent.class);
	...
	public GameObject spawnEnemyShadowSlime(
		...
		if (staticData == null) {
			...
			AnimationFrame idle1 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_shadowslime_idle01), Utils.framesToTime(24, 3), basicAttackVolume, basicVulnerabilityVolume);
			AnimationFrame idle2 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_shadowslime_idle02), Utils.framesToTime(24, 3), basicAttackVolume, basicVulnerabilityVolume);
			idle.addFrame(idle1);
			idle.addFrame(idle2);
			idle.setLoop(true);

			SpriteAnimation appear = new SpriteAnimation(EnemyAnimations.APPEAR.ordinal(), 6);
			AnimationFrame appear1 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_shadowslime_activate01), Utils.framesToTime(24, 2), basicAttackVolume, basicVulnerabilityVolume);

			AnimationFrame appear2 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_shadowslime_activate02), Utils.framesToTime(24, 2), basicAttackVolume, basicVulnerabilityVolume);
			AnimationFrame appear3 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_shadowslime_activate03), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume);
			AnimationFrame appear4 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_shadowslime_activate04), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume);
			AnimationFrame appear5 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_shadowslime_activate05), Utils.framesToTime(24, 2), basicAttackVolume, basicVulnerabilityVolume);
			AnimationFrame appear6 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_shadowslime_activate06), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume);
			...
			/*
			 * hidden.addFrame(new AnimationFrame( textureLibrary.allocateTexture(R.drawable.enemy_shadowslime_stand), Utils.framesToTime(24, 3), basicAttackVolume, basicVulnerabilityVolume));
			 */

			SpriteAnimation attack = new SpriteAnimation(EnemyAnimations.ATTACK.ordinal(), 10);
			AnimationFrame attack1 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_shadowslime_attack01), Utils.framesToTime(24, 2), basicAttackVolume, basicVulnerabilityVolume);
			AnimationFrame attack2 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_shadowslime_attack02), Utils.framesToTime(24, 2), basicAttackVolume, basicVulnerabilityVolume);
			AnimationFrame attack3 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_shadowslime_attack03), Utils.framesToTime(24, 2), basicAttackVolume, basicVulnerabilityVolume);
			AnimationFrame attack4 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_shadowslime_attack04), Utils.framesToTime(24, 6), basicAttackVolume, basicVulnerabilityVolume);
			AnimationFrame attackFlash = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_shadowslime_flash), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume);

			AnimationFrame attack5 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_shadowslime_attack03), Utils.framesToTime(24, 3), basicAttackVolume, basicVulnerabilityVolume);
			AnimationFrame attack6 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_shadowslime_attack02), Utils.framesToTime(24, 3), basicAttackVolume, basicVulnerabilityVolume);

			AnimationFrame attack7 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_shadowslime_attack04), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume);
		...
		LifetimeComponent lifetime = (LifetimeComponent) allocateComponent(LifetimeComponent.class);
		lifetime.setObjectToSpawnOnDeath(GameObjectType.SMOKE_POOF);
		lifetime.setIncrementEventCounter(EventRecorder.COUNTER_SNAILS_DESTROYED);
		SoundSystem sound = BaseObject.sSystemRegistry.soundSystem;
		if (sound != null) {
			lifetime.setDeathSound(sound.load(R.raw.sound_stomp));
		}
	...
	public GameObject spawnEnemyMudman(
			float positionX,
			float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(EnemyAnimations.IDLE.ordinal(), 4);
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_mud_stand), Utils.framesToTime(24, 12), null, null));
			AnimationFrame idle1 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_mud_idle01), Utils.framesToTime(24, 2), null, null);
			AnimationFrame idle2 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_mud_idle01), Utils.framesToTime(24, 7), null, null);
			idle.addFrame(idle1);
			idle.addFrame(idle2);
			idle.addFrame(idle1);
			idle.setLoop(true);
			...
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_mud_walk01), Utils.framesToTime(24, 4), null, null));
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_mud_walk02), Utils.framesToTime(24, 4), null, null));
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_mud_walk03), Utils.framesToTime(24, 5), null, null));
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_mud_walk04), Utils.framesToTime(24, 4), null, null));
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_mud_walk05), Utils.framesToTime(24, 4), null, null));
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_mud_walk06), Utils.framesToTime(24, 5), null, null));
			walk.setLoop(true);
			...
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_mud_stand), Utils.framesToTime(24, 2), null, null));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_mud_attack01), Utils.framesToTime(24, 2), null, null));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_mud_attack02), Utils.framesToTime(24, 2), null, null));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_mud_attack03), Utils.framesToTime(24, 2), null, null));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_mud_attack04), Utils.framesToTime(24, 1), crushAttackVolume, null));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_mud_attack05), Utils.framesToTime(24, 1), crushAttackVolume, null));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_mud_attack06), Utils.framesToTime(24, 8), crushAttackVolume, null));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_mud_attack07), Utils.framesToTime(24, 5), null, null));
	...
	public GameObject spawnEnemySkeleton(
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(EnemyAnimations.IDLE.ordinal(), 1);
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_skeleton_stand), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));

			SpriteAnimation walk = new SpriteAnimation(EnemyAnimations.MOVE.ordinal(), 6);
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_skeleton_walk01), Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_skeleton_walk02), Utils.framesToTime(24, 4), null, basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_skeleton_walk03), Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_skeleton_walk04), Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_skeleton_walk05), Utils.framesToTime(24, 4), null, basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_skeleton_walk03), Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));

			walk.setLoop(true);

			SpriteAnimation attack = new SpriteAnimation(EnemyAnimations.ATTACK.ordinal(), 3);
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_skeleton_attack01), Utils.framesToTime(24, 5), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_skeleton_attack03), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_skeleton_attack04), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume));
		...
		lifetime.setIncrementEventCounter(EventRecorder.COUNTER_SKELETONS_DESTROYED);
	...
	public GameObject spawnEnemyKaraguin(
			float positionX,
			float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_karaguin01), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_karaguin02), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_karaguin03), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume));
			idle.setLoop(true);
		...
		lifetime.setIncrementEventCounter(EventRecorder.COUNTER_KARAGUINS_DESTROYED);
	...
	public GameObject spawnEnemyPinkNamazu(
			float positionX,
			float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			// | | 1| |5
			/*
			 * 0:12,6:22,52:0.98058067569092,-0.19611613513818 0:22,52:50,75:-0.62580046626293,0.77998318983495 0:50,75:81,75:0,1 0:81,75:104,49:0.74038072228541,0.67218776102228
			...
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_pinkdude_stand), Utils.framesToTime(24, 8), null, null));
			AnimationFrame idle1 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_pinkdude_sleep01), Utils.framesToTime(24, 3), null, null);
			AnimationFrame idle2 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_pinkdude_sleep02), Utils.framesToTime(24, 8), null, null);
			idle.addFrame(idle1);
			idle.addFrame(idle2);
			idle.addFrame(idle1);
			idle.setLoop(true);
			...
			AnimationFrame wake1 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_pinkdude_eyeopen), Utils.framesToTime(24, 3), null, null);
			AnimationFrame wake2 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_pinkdude_stand), Utils.framesToTime(24, 3), null, null);
			wake.addFrame(wake1);
			wake.addFrame(wake2);
			wake.addFrame(wake1);
			wake.addFrame(wake2);
			...
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_pinkdude_jump), Utils.framesToTime(24, 2), crushAttackVolume, null));
	...
	public GameObject spawnEnemyBat(
			float positionX,
			float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_bat01), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_bat02), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_bat03), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_bat04), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume));
			idle.setLoop(true);
		...
		lifetime.setObjectToSpawnOnDeath(GameObjectType.SMOKE_POOF);
		SoundSystem sound = BaseObject.sSystemRegistry.soundSystem;
		lifetime.setIncrementEventCounter(EventRecorder.COUNTER_BATS_DESTROYED);
		if (sound != null) {
			lifetime.setDeathSound(sound.load(R.raw.sound_stomp));
		}
	...
	public GameObject spawnEnemySting(
			float positionX,
			float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(0, 3);
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_sting01), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_sting02), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_sting03), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume));
		...
		lifetime.setIncrementEventCounter(EventRecorder.COUNTER_EVENT_STING_DESTROYED);
	...
	public GameObject spawnEnemyOnion(
			float positionX,
			float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(EnemyAnimations.IDLE.ordinal(), 1);
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_onion01), Utils.framesToTime(24, 3), basicAttackVolume, basicVulnerabilityVolume));

			idle.setLoop(true);

			SpriteAnimation walk = new SpriteAnimation(EnemyAnimations.MOVE.ordinal(), 3);
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_onion01), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_onion02), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume));
			walk.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_onion03), Utils.framesToTime(24, 1), basicAttackVolume, basicVulnerabilityVolume));
			walk.setLoop(true);
		...
		lifetime.setVulnerableToDeathTiles(true);
		lifetime.setObjectToSpawnOnDeath(GameObjectType.SMOKE_POOF);
		lifetime.setIncrementEventCounter(EventRecorder.COUNTER_ONIONS_DESTROYED);
		SoundSystem sound = BaseObject.sSystemRegistry.soundSystem;
		if (sound != null) {
			lifetime.setDeathSound(sound.load(R.raw.sound_stomp));
		}
	...
	public GameObject spawnEnemyWanda(
			float positionX,
			float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_stand), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));

			AnimationFrame walkFrame1 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_walk01), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame2 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_walk02), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame3 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_walk03), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame4 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_walk04), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame5 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_walk05), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			...
			AnimationFrame runFrame4 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_run04), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);

			SpriteAnimation run = new SpriteAnimation(NPCAnimationComponent.RUN, 9);
			run.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_run01), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
			run.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_run02), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
			run.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_run03), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
			run.addFrame(runFrame4);
			run.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_run05), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
			run.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_run06), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
			run.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_run07), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
			run.addFrame(runFrame4);
			run.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_run08), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
			run.setLoop(true);

			SpriteAnimation jumpStart = new SpriteAnimation(NPCAnimationComponent.JUMP_START, 4);
			AnimationFrame jump1 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_jump01), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
			AnimationFrame jump2 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_jump01), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
			jumpStart.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_run04), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume));
			jumpStart.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_crouch), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
			...
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_shoot01), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_shoot02), Utils.framesToTime(24, 8), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_shoot03), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_shoot04), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_shoot05), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_shoot06), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_shoot07), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_shoot08), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_shoot09), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_shoot02), Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_wanda_shoot01), Utils.framesToTime(24, 3), null, basicVulnerabilityVolume));
	...
	public GameObject spawnEnemyKyle(
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(NPCAnimationComponent.IDLE, 1);
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kyle_stand), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));

			AnimationFrame walkFrame1 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kyle_walk01), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame2 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kyle_walk02), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame3 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kyle_walk03), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame4 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kyle_walk04), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame5 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kyle_walk05), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame6 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kyle_walk06), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame7 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kyle_walk07), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			...
			AnimationFrame crouch1 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kyle_crouch01), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
			AnimationFrame crouch2 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kyle_crouch02), Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			...
			FixedSizeArray<CollisionVolume> attackVolume = new FixedSizeArray<CollisionVolume>(2);
			...
			run.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kyle_dash01), Utils.framesToTime(24, 1), attackVolume, basicVulnerabilityVolume));
			run.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kyle_dash02), Utils.framesToTime(24, 1), attackVolume, basicVulnerabilityVolume));
			run.setLoop(true);
			...
			SpriteAnimation jumpAir = new SpriteAnimation(NPCAnimationComponent.JUMP_AIR, 2);
			AnimationFrame jump1 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kyle_jump01), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
			AnimationFrame jump2 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kyle_jump01), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
			jumpAir.addFrame(jump1);
			jumpAir.addFrame(jump2);
			jumpAir.setLoop(true);
	...
	public GameObject spawnEnemyKyleDead(
			float positionX,
			float positionY) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			AnimationFrame frame1 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kyle_dead), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
	...
	public GameObject spawnEnemyAndouDead(
			float positionX,
			float positionY) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
	...
	public GameObject spawnEnemyKabocha(
			float positionX,
			float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(NPCAnimationComponent.IDLE, 1);
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_stand), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));

			AnimationFrame walkFrame1 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_walk01), Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame2 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_walk02), Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame3 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_walk03), Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame4 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_walk04), Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame5 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_walk05), Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame6 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_walk06), Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
	...
	public GameObject spawnRokudouTerminal(
			float positionX,
			float positionY) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			AnimationFrame frame1 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_terminal01), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
			AnimationFrame frame2 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_terminal02), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
			AnimationFrame frame3 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_terminal03), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
			AnimationFrame frame4 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_terminal01), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame frame5 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_terminal02), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame frame6 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_terminal01), 1.0f, null, basicVulnerabilityVolume);
	...
	public GameObject spawnKabochaTerminal(
		...
		if (staticData == null) {
			...
			AnimationFrame frame1 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_terminal_kabocha01), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
			AnimationFrame frame2 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_terminal_kabocha02), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
			AnimationFrame frame3 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_terminal_kabocha03), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
			AnimationFrame frame4 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_terminal_kabocha01), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame frame5 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_terminal_kabocha02), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame frame6 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_terminal_kabocha01), 1.0f, null, basicVulnerabilityVolume);
	...
	public GameObject spawnEnemyEvilKabocha(
			float positionX,
			float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(NPCAnimationComponent.IDLE, 1);
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_evil_stand), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));

			AnimationFrame walkFrame1 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_evil_walk01), Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame2 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_evil_walk02), Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame3 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_evil_walk03), Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame4 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_evil_walk04), Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame5 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_evil_walk05), Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			AnimationFrame walkFrame6 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_evil_walk06), Utils.framesToTime(24, 3), null, basicVulnerabilityVolume);
			...
			surprised.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_evil_surprised), 4.0f, null, null));

			SpriteAnimation hit = new SpriteAnimation(NPCAnimationComponent.TAKE_HIT, 2);
			hit.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_evil_hit01), Utils.framesToTime(24, 1), null, null));
			hit.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_evil_hit02), Utils.framesToTime(24, 10), null, null));

			SpriteAnimation die = new SpriteAnimation(NPCAnimationComponent.DEATH, 5);
			die.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_evil_die01), Utils.framesToTime(24, 6), null, null));
			die.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_evil_stand), Utils.framesToTime(24, 2), null, null));
			die.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_evil_die02), Utils.framesToTime(24, 2), null, null));
			die.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_evil_die03), Utils.framesToTime(24, 2), null, null));
			die.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_kabocha_evil_die04), Utils.framesToTime(24, 6), null, null));
	...
	public GameObject spawnEnemyRokudou(
			float positionX,
			float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(NPCAnimationComponent.IDLE, 1);
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_rokudou_fight_stand), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));

			SpriteAnimation fly = new SpriteAnimation(NPCAnimationComponent.WALK, 2);
			fly.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_rokudou_fight_fly01), 1.0f, null, basicVulnerabilityVolume));
			fly.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_rokudou_fight_fly02), 1.0f, null, basicVulnerabilityVolume));
			fly.setLoop(true);

			SpriteAnimation shoot = new SpriteAnimation(NPCAnimationComponent.SHOOT, 2);
			shoot.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_rokudou_fight_shoot01), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume));
			shoot.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_rokudou_fight_shoot02), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume));
			shoot.setLoop(true);

			SpriteAnimation surprised = new SpriteAnimation(NPCAnimationComponent.SURPRISED, 1);
			surprised.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_rokudou_fight_surprise), 4.0f, null, null));

			SpriteAnimation hit = new SpriteAnimation(NPCAnimationComponent.TAKE_HIT, 7);
			AnimationFrame hitFrame1 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_rokudou_fight_hit01), Utils.framesToTime(24, 2), null, null);
			AnimationFrame hitFrame2 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_rokudou_fight_hit02), Utils.framesToTime(24, 1), null, null);
			AnimationFrame hitFrame3 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_rokudou_fight_hit03), Utils.framesToTime(24, 1), null, null);
			...
			SpriteAnimation die = new SpriteAnimation(NPCAnimationComponent.DEATH, 5);
			die.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_rokudou_fight_stand), Utils.framesToTime(24, 6), null, null));
			die.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_rokudou_fight_die01), Utils.framesToTime(24, 2), null, null));
			die.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_rokudou_fight_die02), Utils.framesToTime(24, 4), null, null));
			die.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_rokudou_fight_die03), Utils.framesToTime(24, 6), null, null));
			die.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_rokudou_fight_die04), Utils.framesToTime(24, 6), null, null));
		...
		LaunchProjectileComponent gun2 = (LaunchProjectileComponent) allocateComponent(LaunchProjectileComponent.class);
	...
	public GameObject spawnPlayerGhost(
			float positionX,
			float positionY,
			GameObject player,
			float lifeTime) {
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(0, 4);
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_energyball01), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_energyball02), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_energyball03), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_energyball04), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.setLoop(true);
	...
	public GameObject spawnEnergyBall(
			float positionX,
			float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(0, 4);
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.energy_ball01), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.energy_ball02), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.energy_ball03), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.energy_ball04), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.setLoop(true);
	...
	public GameObject spawnWandaShot(
			float positionX,
			float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
	...
	public GameObject spawnCannonBall(
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(0, 1);
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.snail_bomb), Utils.framesToTime(24, 1), basicAttackVolume, null));
	...
	public GameObject spawnTurretBullet(
			float positionX,
			float positionY,
			boolean flipHorizontal) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.effect_bullet01), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.effect_bullet02), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.setLoop(true);
	...
	public GameObject spawnBrobotBullet(
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(0, 3);
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_brobot_walk01), Utils.framesToTime(24, 1), null, null));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_brobot_walk02), Utils.framesToTime(24, 1), null, null));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.enemy_brobot_walk03), Utils.framesToTime(24, 1), null, null));
			idle.setLoop(true);
	...
	public GameObject spawnCoin(
		...
		if (staticData == null) {
			...
			FixedSizeArray<CollisionVolume> basicVulnerabilityVolume = null; /*
																			 * new FixedSizeArray<CollisionVolume>(1); basicVulnerabilityVolume.add(new SphereCollisionVolume(8, 8, 8));
																			 * basicVulnerabilityVolume.get(0).setHitType(HitType.COLLECT);
																			 */

			SpriteAnimation idle = new SpriteAnimation(0, 5);
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_coin01), Utils.framesToTime(24, 30), null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_coin02), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_coin03), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_coin04), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_coin05), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume));
			idle.setLoop(true);
	...
	public GameObject spawnRuby(
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(0, 5);
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_ruby01), 2.0f, null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_ruby02), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_ruby03), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_ruby04), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_ruby05), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume));
			idle.setLoop(true);
	...
	public GameObject spawnDiary(
		...
		if (staticData == null) {
			...
			AnimationFrame frame1 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_diary01), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);
			AnimationFrame frame2 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_diary02), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume);

			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_diary01), 1.0f, null, basicVulnerabilityVolume));
			idle.addFrame(frame2);
			idle.addFrame(frame1);
			idle.addFrame(frame2);
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_diary03), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_diary04), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_diary05), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_diary06), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume));
		...
		hitReact.setDieWhenCollected(true);
		hitReact.setInvincible(true);
		hitReact.setSpawnGameEventOnHit(CollisionParameters.HitType.COLLECT, GameFlowEvent.EVENT_SHOW_DIARY, 0);
		// TODO: this is pretty dumb. The static data binding needs to be made generic.
		final int staticDataSize = staticData.getCount();
		for (int x = 0; x < staticDataSize; x++) {
			final BaseObject entry = staticData.get(x);
	...
	public GameObject spawnObjectDoor(
			float positionX,
			float positionY,
			GameObjectType type,
			boolean solid) {
		...
		if (staticData == null) {
			...
			final int red_frames[] = { R.drawable.object_door_red01, R.drawable.object_door_red02, R.drawable.object_door_red03, R.drawable.object_door_red04, };

			final int blue_frames[] = { R.drawable.object_door_blue01, R.drawable.object_door_blue02, R.drawable.object_door_blue03, R.drawable.object_door_blue04, };

			final int green_frames[] = { R.drawable.object_door_green01, R.drawable.object_door_green02, R.drawable.object_door_green03, R.drawable.object_door_green04, };
			...
			AnimationFrame frame1 = new AnimationFrame(textureLibrary.allocateTexture(frames[0]), Utils.framesToTime(24, 1), null, vulnerabilityVolume);
			AnimationFrame frame2 = new AnimationFrame(textureLibrary.allocateTexture(frames[1]), Utils.framesToTime(24, 2));
			AnimationFrame frame3 = new AnimationFrame(textureLibrary.allocateTexture(frames[2]), Utils.framesToTime(24, 2));
			AnimationFrame frame4 = new AnimationFrame(textureLibrary.allocateTexture(frames[3]), Utils.framesToTime(24, 1));
			...
			AnimationFrame closeFrame2 = new AnimationFrame(textureLibrary.allocateTexture(frames[1]), Utils.framesToTime(24, 2), attackVolume, vulnerabilityVolume);
	...
	public GameObject spawnObjectButton(
			float positionX,
			float positionY,
			GameObjectType type) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			final int red_frames[] = { R.drawable.object_button_red, R.drawable.object_button_pressed_red, };

			final int blue_frames[] = { R.drawable.object_button_blue, R.drawable.object_button_pressed_blue, };

			final int green_frames[] = { R.drawable.object_button_green, R.drawable.object_button_pressed_green, };
			...
			AnimationFrame frame1 = new AnimationFrame(textureLibrary.allocateTexture(frames[0]), Utils.framesToTime(24, 1), null, vulnerabilityVolume);
			AnimationFrame frame2 = new AnimationFrame(textureLibrary.allocateTexture(frames[1]), Utils.framesToTime(24, 1), null, vulnerabilityVolume);
	...
	public GameObject spawnObjectCannon(
			float positionX,
			float positionY) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			AnimationFrame frame1 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_cannon), 1.0f, attackVolume, null);

			SpriteAnimation idle = new SpriteAnimation(GenericAnimationComponent.Animation.IDLE, 1);
			idle.addFrame(frame1);

			AnimationFrame frame1NoAttack = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_cannon), 1.0f, null, null);
	...
	public GameObject spawnObjectBrobotSpawner(
			float positionX,
			float positionY,
			boolean flipHorizontal) {
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(0, 1);
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_brobot_machine), 1.0f, null, basicVulnerabilityVolume));

			SolidSurfaceComponent solidSurface = (SolidSurfaceComponent) allocateComponent(SolidSurfaceComponent.class);
			solidSurface.inititalize(3);
			/*
			 * 0:2,0:8,59:-0.99532399996093,0.09659262446878 0:8,59:61,33:0.44551558813576,0.89527418187282 0:61,33:61,-1:1,0
			 */
			// trapezoid shape:
			// |\ |\2
			// | | 1| |3
	...
	public GameObject spawnObjectInfiniteSpawner(
			float positionX,
			float positionY) {
	...
	public GameObject spawnObjectCrusherAndou(
			float positionX,
			float positionY) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.andou_stand), 1.0f, null, basicVulnerabilityVolume));

			FixedSizeArray<CollisionVolume> stompAttackVolume = new FixedSizeArray<CollisionVolume>(1);
			stompAttackVolume.add(new AABoxCollisionVolume(16, -5.0f, 32, 37, HitType.HIT));
	...
	public GameObject spawnObjectBreakableBlock(
			float positionX,
			float positionY) {
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(0, 1);
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_debris_block), 1.0f, null, basicVulnerabilityVolume));
	...
	public GameObject spawnObjectTheSource(
			float positionX,
			float positionY) {
	...
	public GameObject spawnObjectSign(
			float positionX,
			float positionY) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(0, 1);
			AnimationFrame frame1 = new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_sign), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume);
	...
	public GameObject spawnObjectTurret(
			float positionX,
			float positionY,
			boolean flipHorizontal) {
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(EnemyAnimations.IDLE.ordinal(), 2);
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_gunturret01), 1.0f, null, basicVulnerabilityVolume));
			idle.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_gunturret_idle), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
			idle.setLoop(true);

			SpriteAnimation attack = new SpriteAnimation(EnemyAnimations.ATTACK.ordinal(), 4);
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_gunturret02), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_gunturret01), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_gunturret03), Utils.framesToTime(24, 2), null, basicVulnerabilityVolume));
			attack.addFrame(new AnimationFrame(textureLibrary.allocateTexture(R.drawable.object_gunturret01), Utils.framesToTime(24, 1), null, basicVulnerabilityVolume));
			attack.setLoop(true);
		...
		AttackAtDistanceComponent attack = (AttackAtDistanceComponent) allocateComponent(AttackAtDistanceComponent.class);
		...
		lifetime.setIncrementEventCounter(EventRecorder.COUNTER_TURRET_DESTROYED);
	...
	public GameObject spawnDust(
		...
		if (staticData == null) {
			...
			SpriteAnimation idle = new SpriteAnimation(0, 5);
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.dust01), Utils.framesToTime(24, 1)));
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.dust02), Utils.framesToTime(24, 1)));
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.dust03), Utils.framesToTime(24, 1)));
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.dust04), Utils.framesToTime(24, 1)));
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.dust05), Utils.framesToTime(24, 1)));
	...
	public GameObject spawnEffectExplosionSmall(
		...
		if (staticData == null) {
			...
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_small01), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_small02), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_small03), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_small04), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_small05), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_small06), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_small07), Utils.framesToTime(24, 1), basicAttackVolume, null));
	...
	public GameObject spawnEffectExplosionLarge(
			float positionX,
			float positionY) {
		TextureLibrary textureLibrary = sSystemRegistry.longTermTextureLibrary;
		...
		if (staticData == null) {
			...
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_big01), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_big02), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_big03), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_big04), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_big05), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_big06), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_big07), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_big08), Utils.framesToTime(24, 1), basicAttackVolume, null));
			idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_big09), Utils.framesToTime(24, 1), basicAttackVolume, null));
	...
	public GameObject spawnEffectExplosionGiant(
		...
		if (staticData == null) {
			...
			AnimationFrame smallFrame1 = new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_small01), Utils.framesToTime(24, 1), null, null);
			AnimationFrame smallFrame2 = new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_small02), Utils.framesToTime(24, 1), null, null);
			AnimationFrame smallFrame3 = new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_small03), Utils.framesToTime(24, 1), null, null);
			AnimationFrame smallFrame4 = new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_small04), Utils.framesToTime(24, 1), null, null);
			AnimationFrame smallFrame5 = new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_small05), Utils.framesToTime(24, 1), null, null);
			AnimationFrame smallFrame6 = new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_small06), Utils.framesToTime(24, 1), null, null);
			AnimationFrame smallFrame7 = new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_explosion_small07), Utils.framesToTime(24, 1), null, null);
		...
		LifetimeComponent lifetime = (LifetimeComponent) allocateComponent(LifetimeComponent.class);
		lifetime.setTimeUntilDeath(Math.max(Math.max(Math.max(idle.getLength(), smallBlast1.getLength()), smallBlast2.getLength()), smallBlast3.getLength()));
	...
	public GameObject spawnGhostNPC(
			float positionX,
			float positionY) {
	...
	private GameObject spawnCameraBias(
			float positionX,
			float positionY) {
		GameObject object = mGameObjectPool.allocate();
		object.getPosition().set(positionX, positionY);
	...
	public GameObject spawnEffectSmokeBig(
			float positionX,
			float positionY) {
		TextureLibrary textureLibrary = sSystemRegistry.longTermTextureLibrary;
		...
		if (componentAvailable(RenderComponent.class, 1)) {
			...
			if (staticData == null) {
				...
				AnimationFrame frame2 = new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_smoke_big02), Utils.framesToTime(24, 1), null, null);

				AnimationFrame frame3 = new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_smoke_big03), Utils.framesToTime(24, 1), null, null);

				AnimationFrame frame4 = new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_smoke_big04), Utils.framesToTime(24, 1), null, null);

				AnimationFrame frame5 = new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_smoke_big05), Utils.framesToTime(24, 1), null, null);

				SpriteAnimation idle = new SpriteAnimation(0, 5);
				idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_smoke_big01), Utils.framesToTime(24, 10), null, null));
				idle.addFrame(frame2);
				idle.addFrame(frame3);
				idle.addFrame(frame4);
				idle.addFrame(frame5);
				...
				idle2.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_smoke_big01), Utils.framesToTime(24, 13), null, null));
				...
				idle3.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_smoke_big01), Utils.framesToTime(24, 8), null, null));
				...
				idle4.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_smoke_big01), Utils.framesToTime(24, 5), null, null));
				...
				idle5.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_smoke_big01), Utils.framesToTime(24, 15), null, null));
	...
	public GameObject spawnEffectSmokeSmall(
			float positionX,
			float positionY) {
		TextureLibrary textureLibrary = sSystemRegistry.longTermTextureLibrary;
		...
		if (componentAvailable(RenderComponent.class, 1)) {
			...
			if (staticData == null) {
				...
				SpriteAnimation idle = new SpriteAnimation(0, 5);
				idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_smoke_small01), Utils.framesToTime(24, 10), null, null));
				idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_smoke_small02), Utils.framesToTime(24, 1), null, null));
				idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_smoke_small03), Utils.framesToTime(24, 1), null, null));
				idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_smoke_small04), Utils.framesToTime(24, 1), null, null));
				idle.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_smoke_small05), Utils.framesToTime(24, 1), null, null));
	...
	public GameObject spawnEffectCrushFlash(
			float positionX,
			float positionY) {
		TextureLibrary textureLibrary = sSystemRegistry.longTermTextureLibrary;
		...
		if (componentAvailable(RenderComponent.class, 1)) {
			...
			if (staticData == null) {
				...
				back.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_crush_back01), Utils.framesToTime(24, 1), null, null));
				back.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_crush_back02), Utils.framesToTime(24, 1), null, null));
				back.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_crush_back03), Utils.framesToTime(24, 1), null, null));

				SpriteAnimation front = new SpriteAnimation(1, 7);
				front.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_crush_front01), Utils.framesToTime(24, 1), null, null));
				front.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_crush_front02), Utils.framesToTime(24, 1), null, null));
				front.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_crush_front03), Utils.framesToTime(24, 1), null, null));
				front.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_crush_front04), Utils.framesToTime(24, 1), null, null));
				front.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_crush_front05), Utils.framesToTime(24, 1), null, null));
				front.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_crush_front06), Utils.framesToTime(24, 1), null, null));
				front.addFrame(new AnimationFrame(textureLibrary.getTextureByResource(R.drawable.effect_crush_front07), Utils.framesToTime(24, 1), null, null));
	...
	public GameObject spawnEffectFlash(
			float positionX,
			float positionY) {
		TextureLibrary textureLibrary = sSystemRegistry.longTermTextureLibrary;
		GameObject object = null;
	...
	public GameObject spawnFrameRateWatcher(
		...
		DrawableBitmap indicator = new DrawableBitmap(textureLibrary.allocateTexture(R.drawable.framerate_warning), (int) object.width, (int) object.height);
	...
	public GameObject spawnBreakableBlockPiece(
			float positionX,
			float positionY) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		...
		if (staticData == null) {
			...
			DrawableBitmap piece = new DrawableBitmap(textureLibrary.getTextureByResource(R.drawable.object_debris_piece), (int) object.width, (int) object.height);
	...
	public GameObject spawnBreakableBlockPieceSpawner(
			float positionX,
			float positionY) {
		...
		LaunchProjectileComponent pieceSpawner = (LaunchProjectileComponent) allocateComponent(LaunchProjectileComponent.class);
	...
	public GameObject spawnSmokePoof(
			float positionX,
			float positionY) {
	...
	public GameObject spawnGemEffect(
			float positionX,
			float positionY) {
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
	...
	public GameObject spawnGemEffectSpawner(
			float positionX,
			float positionY) {
		...
		for (int x = 0; x < gems; x++) {
			LaunchProjectileComponent gemGun = (LaunchProjectileComponent) allocateComponent(LaunchProjectileComponent.class);
	...
	private final static class ComponentPoolComparator implements Comparator<GameComponentPool> {
		@Override
		public int compare(
				final GameComponentPool object1,
