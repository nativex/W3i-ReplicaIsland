...
/**
 * A very simple manager for orthographic in-game UI elements. TODO: This should probably manage a number of hud objects in keeping with the component-centric architecture of this engine. The current
 * code is monolithic and should be refactored.
 */
public class HudSystem extends BaseObject {
	...
	public void setButtonDrawables(
			DrawableBitmap disabled,
			DrawableBitmap enabled,
			DrawableBitmap depressed,
			DrawableBitmap stompEnabled,
			DrawableBitmap stompDepressed,
			DrawableBitmap sliderBase,
			DrawableBitmap sliderButton,
			DrawableBitmap sliderDepressed) {
	...
	public void setDigitDrawables(
			DrawableBitmap[] digits,
			DrawableBitmap xMark) {
		mXDrawable = xMark;
	...
	public void setCollectableDrawables(
			DrawableBitmap coin,
			DrawableBitmap coin2,
			DrawableBitmap ruby) {
		mCoinDrawable = coin;
	...
	public void updateInventory(
			InventoryComponent.UpdateRecord newInventory) {
	...
	public void setMovementSliderMode(
			boolean sliderOn) {
	...
	public void setMovementSliderOffset(
			float offset) {
	...
	public void update(
		...
		if (manager != null && manager.getPlayer() != null) {
			...
			if (mFuelDrawable != null && mFuelBackgroundDrawable != null && render != null && pool != null && factory != null && params != null) {
				...
				location.set(FUEL_BAR_EDGE_PADDING, params.gameHeight - height - FUEL_BAR_EDGE_PADDING);
