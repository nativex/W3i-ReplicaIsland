...
/**
 * Helper class for interpolating velocity over time given a target velocity and acceleration. The current velocity will be accelerated towards the target until the target is reached. Note that
 * acceleration is effectively an absolute value--it always points in the direction of the target velocity.
 */
