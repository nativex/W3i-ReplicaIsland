...
public class LevelBuilder extends BaseObject {
	...
	public GameObject buildBackground(
		...
		if (textureLibrary != null) {
			...
			if (backgroundResource > -1) {
				...
				ScrollerComponent scroller3 = new ScrollerComponent(0.0f, 0.0f, width, height, textureLibrary.allocateTexture(backgroundResource));
	...
	public void addTileMapLayer(
		...
		// Vertex Buffer Code
		TextureLibrary textureLibrary = sSystemRegistry.shortTermTextureLibrary;
		TiledVertexGrid bg = new TiledVertexGrid(textureLibrary.allocateTexture(tileMapIndex), width, height, tileWidth, tileHeight);
		bg.setWorld(world);
		...
		ScrollerComponent scroller = new ScrollerComponent(xScrollSpeed, yScrollSpeed, width, height, bg);
	...
	public void promoteForegroundLayer(
