...
public class OpenGLSystem extends BaseObject {
	...
	public static final void setGL(
			GL10 gl) {
		sGL = gl;
		sLastBoundTexture = 0;
	...
	public static final void bindTexture(
			int target,
			int texture) {
	...
	public static final void setTextureCrop(
			int[] crop) {
		int cropSignature = 0;
		...
		if (cropSignature != sLastSetCropSignature) {
			((GL11) sGL).glTexParameteriv(GL10.GL_TEXTURE_2D, GL11Ext.GL_TEXTURE_CROP_RECT_OES, crop, 0);
