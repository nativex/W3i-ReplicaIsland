...
public class SimplePhysicsComponent extends GameComponent {
	...
	public void update(
		...
		if ((parentObject.touchingCeiling() && velocityY > 0.0f) || (parentObject.touchingGround() && velocityY < 0.0f)) {
		...
		if ((parentObject.touchingRightWall() && velocityX > 0.0f) || (parentObject.touchingLeftWall() && velocityX < 0.0f)) {
