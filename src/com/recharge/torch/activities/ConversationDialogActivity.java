...
import com.recharge.torch.ConversationUtils;
import com.recharge.torch.ConversationUtils.Conversation;
import com.recharge.torch.ConversationUtils.ConversationPage;
...
public class ConversationDialogActivity extends Activity {
	...
	protected void showPage(
			ConversationUtils.ConversationPage page) {
		TypewriterTextView tv = (TypewriterTextView) findViewById(R.id.typewritertext);
	...
	public static class TypewriterTextView extends TextView {
		...
		public void setParentActivity(
				ConversationDialogActivity parent) {
			mParentActivity = parent;
		}

		public void setTypewriterText(
				CharSequence text) {
			mText = text;
			mCurrentCharacter = 0;
			mLastTime = 0;
