...
import com.recharge.torch.SingleTouchFilter;
import com.recharge.torch.TouchFilter;
...
public class MainMenuActivity extends Activity implements AdvertiserListener {
	...
	private void doW3iInitialization() {
		...
		// Log.d("com.recharge.torch", "serialnumber: " +
	...
	public void onActionComplete(
		...
		if (success == true) {
			Log.d("com.recharge.torch", "awr success");
		}
	}
