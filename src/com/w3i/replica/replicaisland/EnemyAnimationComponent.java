...
/**
 * A general-purpose animation selection system for animating enemy characters. Most enemy characters behave similarly, so this code tries to decide which animation bets fits their current state.
 * Other code (such as enemy AI) may move these characters around and change the current ActionType, which will result in this code figuring out which sequence of animations is best to play.
 */
