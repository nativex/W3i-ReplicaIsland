...
public final class LevelTree {
	...
	public static class Level {
		...
		public Level(int level, DialogEntry dialogs, String title, String time, boolean pastEvent, boolean restartOnDeath, boolean waitMessage) {
			resource = level;
	...
	public static final void loadLevelTree(
			int resource,
			Context context) {
	...
	public final static void loadAllDialog(
			Context context) {
	...
	public final static void updateCompletedState(
			int levelRow,
			int completedLevels) {
	...
	public final static int packCompletedLevels(
			int levelRow) {
		int completed = 0;
	...
	public static boolean levelIsValid(
			int row,
			int index) {
		boolean valid = false;
	...
	public static boolean rowIsValid(
			int row) {
		boolean valid = false;
		if (row >= 0 && row < levels.size()) {
			valid = true;
