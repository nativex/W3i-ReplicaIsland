...
public class MovementComponent extends GameComponent {
	...
	public void update(
		...
		sInterpolator.set(object.getVelocity().x, object.getTargetVelocity().x, object.getAcceleration().x);
		...
		sInterpolator.set(object.getVelocity().y, object.getTargetVelocity().y, object.getAcceleration().y);
