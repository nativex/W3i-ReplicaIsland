...
/**
 * A component that allows a game object to act like a solid object by submitting surfaces to the background collision system every frame.
 */
public class SolidSurfaceComponent extends GameComponent {
	...
	public void inititalize(
			int maxSurfaceCount) {
		if (mStartPoints == null || (mStartPoints != null && mStartPoints.getCount() != maxSurfaceCount)) {
