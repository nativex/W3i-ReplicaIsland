...
/**
 * TiledWorld manages a 2D map of tile indexes that define a "world" of tiles. These may be foreground or background layers in a scrolling game, or a layer of collision tiles, or some other type of
 * tile map entirely. The TiledWorld maps xy positions to tile indices and also handles deserialization of tilemap files.
 */
