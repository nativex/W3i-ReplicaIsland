...
/**
 * This class manages drawable objects that have short lifetimes (one or two frames). It provides type-specific allocator functions and a type-insensitive release function. This class manages pools of
 * objects so no actual allocations occur after bootstrap.
 */
