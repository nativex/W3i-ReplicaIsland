...
/**
 * A game component that implements gravity. Adding this component to a game object will cause it to be pulled down towards the ground.
 */
public class GravityComponent extends GameComponent {
	...
	public void setGravityMultiplier(
			float multiplier) {
		mGravity.set(sDefaultGravity);
