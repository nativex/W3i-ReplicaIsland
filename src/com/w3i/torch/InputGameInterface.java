...
public class InputGameInterface extends BaseObject {
	...
	public void update(
		...
		if (mUseOnScreenControls) {
			final InputXY sliderTouch = touch.findPointerInRegion(ButtonConstants.MOVEMENT_SLIDER_REGION_X, ButtonConstants.MOVEMENT_SLIDER_REGION_Y, ButtonConstants.MOVEMENT_SLIDER_REGION_WIDTH, ButtonConstants.MOVEMENT_SLIDER_REGION_HEIGHT);
			...
			mDirectionalPad.setMagnitude(filterOrientationForMovement(orientation.getX()), filterOrientationForMovement(orientation.getY()));
		} else {
			// keys or trackball
		...
		final InputXY jumpTouch = touch.findPointerInRegion(flyButtonRegionX, ButtonConstants.FLY_BUTTON_REGION_Y, ButtonConstants.FLY_BUTTON_REGION_WIDTH, ButtonConstants.FLY_BUTTON_REGION_HEIGHT);
		...
		final InputXY stompTouch = touch.findPointerInRegion(stompButtonRegionX, ButtonConstants.STOMP_BUTTON_REGION_Y, ButtonConstants.STOMP_BUTTON_REGION_WIDTH, ButtonConstants.STOMP_BUTTON_REGION_HEIGHT);
	...
	private float filterOrientationForMovement(
			float magnitude) {
	...
	public void setUseClickForAttack(
			boolean click) {
		mUseClickButtonForAttack = click;
	}

	public void setUseOrientationForMovement(
			boolean orientation) {
		mUseOrientationForMovement = orientation;
	}

	public void setOrientationMovementSensitivity(
			float sensitivity) {
	...
	public void setUseOnScreenControls(
			boolean onscreen) {
