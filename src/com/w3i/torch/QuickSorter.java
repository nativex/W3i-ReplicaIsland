...
public class QuickSorter<Type> extends Sorter<Type> {
	 ...
	 * 
	 * On average, this quicksort algorithm runs in time proportional to N log N, independent of the input distribution. The algorithm uses Sedgewick's partitioning method which stops on equal keys.
	 * This protects against cases that make many textbook implementations, even randomized ones, go quadratic (e.g., all keys are the same).
	 * 
	 *************************************************************************/
