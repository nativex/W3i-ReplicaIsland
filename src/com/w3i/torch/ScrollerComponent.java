...
/**
 * Adjusts the scroll position of a drawable object based on the camera's focus position. May be used to scroll a ScrollableBitmap or TiledWorld to match the camera. Uses DrawableFactory to allocate
 * fire-and-forget drawable objects every frame.
 */
public class ScrollerComponent extends GameComponent {
	...
	public void setRenderComponent(
