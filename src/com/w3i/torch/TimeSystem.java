...
/**
 * Maintains a canonical time step, in seconds, for the entire game engine. This time step represents real changes in time but is only updated once per frame.
 */
